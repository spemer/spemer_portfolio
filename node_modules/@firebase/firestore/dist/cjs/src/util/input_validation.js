...
function validateNamedPropertyEquals(functionName, inputName, optionName, input, expected) {
    ...
    throw new error_1.FirestoreError(error_1.Code.INVALID_ARGUMENT, "Invalid value " + actualDescription + " provided to function " + functionName + "() for option \"serverTimestamps\". Acceptable values: " + expectedDescription.join(', '));
}
